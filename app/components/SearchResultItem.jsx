  ...
  render() {
    ...
    const content = (
      <div style={dimDivStyle}>
        ...
        <Button className="blue mini circular icon" onClick={this.onClickLeft.bind(this)}><Icon name="add circle"/></Button>
        <Button className="blue mini circular icon" onClick={this.onClickRight.bind(this)}><Icon name="add circle"/></Button>
      </div>
    )
